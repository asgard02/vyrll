      ...
      >
        <div className="flex min-w-0 flex-1 items-center gap-3 sm:gap-3.5">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1.5 flex items-center gap-1 text-[12px] font-medium text-[#1d1d1f]/35 transition-colors group-hover:text-[#100e0e]">
              Voir le post
...
function BrivaelCard() {
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5 border-t border-[#e5e5e7] pt-3.5 text-[12px] font-medium text-[#1d1d1f]/40 transition-colors group-hover:text-[#100e0e]">
        Voir le post
        <ArrowUpRight className="size-3.5" aria-hidden />
      </div>
    </a>
